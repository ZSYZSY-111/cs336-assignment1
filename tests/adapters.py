...
from nn_util import cross_entropy, gradient_clipping, softmax
...
def run_multihead_self_attention(
    ...
    """
    attn = MultiHeadAttention(d_model, num_heads, device=in_features.device, dtype=in_features.dtype)
